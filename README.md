...
- Wild cards can be used in the stack or appscript parameters. Example: `... stack=*ShortLinks* ...` where all stacks containing the name 'ShortLinks' will be included in the run
